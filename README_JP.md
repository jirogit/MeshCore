...
### 最新リリース → [Releases ページ](../../releases/latest)

| デバイス | MCU | Radio | ファイル | 書き込み方法 |
|---|---|---|---|---|
| WisMesh Tag | nRF52840 | SX1262 | `RAK_WisMesh_Tag_companion_radio_ble-jp-v*.uf2` | ✅ ドラッグ＆ドロップ（推奨） |
| WisMesh Tag | nRF52840 | SX1262 | `RAK_WisMesh_Tag_companion_radio_ble-jp-v*_dfu.zip` | nRF Connect Programmer |
| T1000-E | nRF52840 | LR1110 | `t1000e_companion_radio_ble-jp-v*.uf2` | ✅ ドラッグ＆ドロップ（推奨） |
| T1000-E | nRF52840 | LR1110 | `t1000e_companion_radio_ble-jp-v*_dfu.zip` | nRF Connect Programmer |
...
**1. ファームウェアをダウンロード**  
[Releasesページ](../../releases/latest)から `RAK_WisMesh_Tag_companion_radio_ble-jp-v*.uf2` をダウンロード。
...
**1. ファームウェアをダウンロード**  
[Releasesページ](../../releases/latest)から `t1000e_companion_radio_ble-jp-v*.uf2` をダウンロード。
...
### 手順（DFU zip — OTAや代替手段として）

[nRF Connect for Desktop](https://www.nordicsemi.com/Products/Development-tools/nRF-Connect-for-Desktop) をインストールし、**Programmer** アプリを開く。  
`t1000e_companion_radio_ble-jp-v*_dfu.zip` を選択して書き込む。
...
> 周波数を 920.8 / 921.0 / 921.2 MHz のいずれかに設定すると、このファームウェアのLBTが自動的に有効になります。
